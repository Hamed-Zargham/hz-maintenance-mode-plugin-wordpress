=== HZ Maintenance Mode ===
Contributors: hamedzargham
Tags: maintenance, maintenance mode, coming soon, under construction, unavailable
...
Restrict public access to your site during updates, maintenance, or development.
...
You can find the plugin's settings under the "Settings" menu in the WordPress dashboard.

== Installation ==

**Installation**

First, download the **hz-maintenance-mode** plugin ZIP file to your computer.
...
1. General Settings
2. Social Networks Settings
3. Maintenance Mode Content

Contributors & Developers

“HZ Maintenance Mode Plugin by NiteoThemes” is open source software. The following people have contributed to this plugin.

Here's a link to [Hamed Zargham](https://profiles.wordpress.org/hamedzargham)
