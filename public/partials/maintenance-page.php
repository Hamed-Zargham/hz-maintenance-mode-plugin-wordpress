...
$page_bkg_color        = get_option( 'hzmaint_page_bkg_color' );
$heading_tag           = get_option( 'hzmaint_heading_tag' );
$heading_text          = get_option( 'hzmaint_heading_text' );
$heading_color         = get_option( 'hzmaint_heading_color' );
$desc_text             = get_option( 'hzmaint_desc_text' );
$show_dashboard_link   = get_option( 'hzmaint_show_dashboard_link' );
$dashboard_link_text   = get_option( 'hzmaint_dashboard_link_text' );
$dashboard_link_color  = get_option( 'hzmaint_dashboard_link_color' );
$social_heading_tag    = get_option( 'hzmaint_social_heading_tag' );
$social_heading_text   = get_option( 'hzmaint_social_heading_text' );
$social_heading_color  = get_option( 'hzmaint_social_heading_color' );
$social_icons_color    = get_option( 'hzmaint_social_icons_color' )
?>
...
<div id="maintenance-mode-page">
    ...
    <div id="hzmaint-heading-container" class="<?php echo is_rtl() ? 'hzmaint-rtl-font' : ''; ?>">
      <?php
        // Display the heading
    ...
    <div id="hzmaint-maintenance-description" class="<?php echo is_rtl() ? 'hzmaint-rtl-font' : ''; ?>">
      <?php
    ...
    <?php if ( $show_dashboard_link ) : ?>
      <div id="hzmaint-dashboard-link" >
        <p class="<?php echo is_rtl() ? 'hzmaint-rtl-font' : ''; ?>">
    ...
    <div id="hzmaint-social-heading-container" class="<?php echo is_rtl() ? 'hzmaint-rtl-font' : ''; ?>">
    <?php
    ...
    <?php
      ...
      if ( ! empty( $saved_social_urls ) ) {
        echo '<div id="hzmaint-social-networks-container" class="social-icons">';
